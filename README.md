...
- Trained Models:
    ...
    - Logistic Regression (with L1/Lasso/Elastic Net regularization)
...
- Clinical Interpretation: Ranking feature importance (Lasso weights, RF Importance, VIP Scores) to reveal which brain regions and bands most influence pain classification.
...
* **`test_models.ipynb`**: Integration of clinical data and PSD (Power Spectral Density) extraction for the **Eyes Open** condition. Implementation of classification pipelines to distinguish pain severity levels.
